...
![The Language Pack Welcome Window](images/10/Language_pack_welcome.png)
...
![The Ready to Install dialog](images/10/Language_pack_ready_to_install.png)
...
![The Installing dialog](images/10/Language_pack_installing_language_pack.png)
...
![The Language Pack Setup Complete dialog](images/10/Language_pack_completed_installation.png)
...
![The Stack Builder Welcome Window](images/10/Language_pack_installing_with_stackbuilder_plus.png)
